      ...
      <div className="pt-28 pb-24 px-4 md:px-8 max-w-[1600px] mx-auto animate-in fade-in duration-700">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-400 mt-4 text-base md:text-lg max-w-2xl">
            Real-time trending products ranked by the Nexusply intelligence engine. High margin, high demand opportunities updated daily.
          </p>
          ...
          {features.winningProducts.delay > 0 && (
            <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-2xl inline-flex items-center gap-3">
              ...
              <p className="text-sm font-medium text-red-400">
                Your plan has a {features.winningProducts.delay}h delay on new winners. <Link href="/dashboard/profile?tab=plan" className="underline font-bold hover:text-red-300 transition-colors ml-1">Upgrade to Importateur</Link> for instant access.
              </p>
            </div>
          )}
        </div>
...
function LockedCard() {
  return (
    <div className="relative bg-white/5 backdrop-blur-2xl border border-white/10 border-dashed rounded-[2rem] h-[340px] flex flex-col items-center justify-center p-6 group overflow-hidden">
      ...
      <p className="text-gray-500 font-bold uppercase tracking-wider text-[10px] mb-2">Locked Feature</p>
      <p className="text-gray-400 text-sm text-center font-medium px-4">
        This high-potential product is reserved for Premium users.
      </p>
    </div>
  )
}
