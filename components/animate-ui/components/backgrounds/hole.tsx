  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_20%,black_70%)] before:[transform:translate3d(-50%,-50%,0)]',
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,rgba(255,255,255,0.08)_20%,transparent_70%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay',
        className,
      )}
      {...props}
    >
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 block size-full opacity-40"
      />

      <motion.div
        className={cn(
          'absolute top-[-71.5%] left-1/2 z-[3] w-[30%] h-[140%] rounded-b-full blur-3xl opacity-70 mix-blend-plus-lighter [transform:translate3d(-50%,0,0)] [background-position:0%_100%] [background-size:100%_200%]',
          '[background:linear-gradient(180deg,rgba(255,255,255,0.35),rgba(255,255,255,0.05),transparent)_0_100%_/_100%_200%]',
        )}
      ...
      <div className="absolute top-0 left-0 z-[7] size-full [background:repeating-linear-gradient(transparent,transparent_1px,rgba(255,255,255,0.05)_2px)] mix-blend-overlay opacity-60" />
    </div>
  );
}
